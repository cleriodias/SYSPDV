...
export default function UnitCreate({ auth, planSettings }) {
                    ...
                    <div className="bg-gray-50 text-sm dark:bg-gray-700 p-4 rounded-lg shadow-m">
                        <form onSubmit={handleSubmit}>
                            <div className="mb-4 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
                                Esta filial sera cadastrada com mensalidade fixa de {formatCurrency(planSettings?.branch_monthly_price)}.
                                Se o plano mudar depois, esta filial continua com o valor contratado agora.
                            </div>
