    ...
    useEffect(() => {
        const handler = setTimeout(() => {
            ...
            if (!isNumeric && term.length < MIN_SEARCH_CHARACTERS) {
                setSearchError(`Digite pelo menos ${MIN_SEARCH_CHARACTERS} caracteres ou utilize codigo.`);
                return;
            }
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                ...
                                <input
                                    ...
                                    placeholder="Digite codigo, codigo de barras ou nome"
                        ...
                        <thead className="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <td className="px-4 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">
                                    {renderSortHeader('Codigo', 'produto_id')}
                                </td>
                                <td className="px-4 py-3 text-left text-sm font-medium text-gray-500 tracking-wider">
