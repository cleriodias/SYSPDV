                                ...
                                <label className="flex items-start gap-3 text-sm text-gray-700">
                                    ...
                                    <span>
                                        ...
                                        <span className="mt-1 block text-xs text-gray-500">
                                            {isBalanceProduct
                                                ? "Produtos de balanca sempre usam o proprio codigo do produto no campo tb1_codbar."
                                                : "Quando marcado, o sistema gravara o proprio codigo do produto no campo tb1_codbar."}
                                        </span>
                                    </span>
                                </label>
                            ...
                            {isBalanceProduct ? (
                                <div className="mb-4 rounded-md border border-amber-200 bg-amber-50 p-4">
                                    ...
                                    <input
                                        ...
                                        type="number"
                                        min="1"
                                        placeholder="Informe o produto_id"
                                        value={data.produto_id}
                                        onChange={(e) => setData("produto_id", e.target.value)}
                                        className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                                    />
                                    <p className="mt-2 text-xs text-amber-800">
                                        Produto de balanca nao usa codigo de barras. Informe o codigo do produto manualmente.
                                        O sistema gravara esse mesmo codigo no campo tb1_codbar. Se o codigo ja existir,
                                        o cadastro sera bloqueado e os dados atuais serao exibidos. Codigos de 3000 a
                                ...
                                <div className="mb-4 rounded-md border border-amber-200 bg-amber-50 p-4">
                                    ...
                                    <p className="mt-2 text-xs text-amber-800">
                                        ...
                                        produto_id gerado automaticamente para o campo tb1_codbar.
                                    </p>
