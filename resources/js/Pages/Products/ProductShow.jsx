            ...
            <div className="py-4 max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div className="overflow-hidden bg-white shadow-lg sm:rounded-lg dark:bg-gray-800">
                    ...
                    <div className="bg-gray-50 text-sm dark:bg-gray-700 p-4 rounded-lg shadow-m">
                        <div className="mb-4">
                            <p className="text-md font-semibold text-gray-700 dark:text-gray-200">Codigo do produto</p>
                            <p className="text-gray-600 dark:text-gray-400">{product.produto_id ?? product.tb1_id}</p>
                        </div>
                        <div className="mb-4">
